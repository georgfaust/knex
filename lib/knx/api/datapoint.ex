...
#   - changes:
#   -- changed module name
#   -- copied module guards here

defmodule Knx.Datapoint do
  @moduledoc """
  ...
  separated by a dot, e.g. `"1.001"`. The type carries information as to the
  ...
  def decode(<<_::5, decoded::1>>, <<"1.", _::binary>>), do: {:ok, decoded}
  ...
  def encode(0, <<"1.", _::binary>>), do: {:ok, <<0::5, 0::1>>}
  def encode(1, <<"1.", _::binary>>), do: {:ok, <<0::5, 1::1>>}
